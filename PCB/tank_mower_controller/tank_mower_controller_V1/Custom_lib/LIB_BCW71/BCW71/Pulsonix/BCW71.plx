...
(library Library_1
	...
	(symbolDef "BCW71" (originalName "BCW71")
	...
	(compDef "BCW71" (originalName "BCW71") (compHeader (numPins 3) (numParts 1) (refDesPrefix Q)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "BCW71"))
		...
		(attr "Manufacturer_Part_Number" "BCW71")
		(attr "Mouser Part Number" "512-BCW71")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/onsemi-Fairchild/BCW71?qs=UMEuL5FsraBSW5kwcQ3Wug%3D%3D")
		(attr "Arrow Part Number" "BCW71")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/bcw71/on-semiconductor?region=europe")
		(attr "Description" "Bipolar Transistors - BJT SOT-23 NPN GP AMP")
		(attr "<Hyperlink>" "https://componentsearchengine.com/Datasheets/2/BCW71.pdf")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "BCW71.stp")
